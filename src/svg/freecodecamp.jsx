...
export const FCCIcon = () => {
    return (
      
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="40px" height="40px" preserveAspectRatio="xMidYMid meet" version="1.1" viewBox="0 0 712 484">
      <defs>
      ...
      <g>
        <g>
            <g>
                <use fill="#fff" fillOpacity="1" opacity="1" xlinkHref="#a1UGBK5Jf"/>
                <g>
                    <use fillOpacity="0" stroke="#fff" strokeOpacity="0" strokeWidth="1" opacity="1" xlinkHref="#a1UGBK5Jf"/>
                </g>
            </g>
            <g>
                <use fill="#fff" fillOpacity="1" opacity="1" xlinkHref="#a8LR3SBcZL"/>
                <g>
                    <use fillOpacity="0" stroke="#fff" strokeOpacity="0" strokeWidth="1" opacity="1" xlinkHref="#a8LR3SBcZL"/>
                </g>
            </g>
            <g>
                <use fill="#fff" fillOpacity="1" opacity="1" xlinkHref="#eYLbcOweH"/>
                <g>
                    <use fillOpacity="0" stroke="#fff" strokeOpacity="0" strokeWidth="1" opacity="1" xlinkHref="#eYLbcOweH"/>
                </g>
            </g>
        </g>
      </g>
