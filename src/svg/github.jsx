...
export const GithubIcon = ({gradient = false}) => {
  return (
    <>
    {gradient ?

    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" role="img" viewBox="0 0 24 24" height="35px" width="35px" xmlns="http://www.w3.org/2000/svg">
      <defs>
